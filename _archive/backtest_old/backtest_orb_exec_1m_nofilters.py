...
def ensure_schema(con: duckdb.DuckDBPyConnection):
    con.execute("""
        CREATE TABLE IF NOT EXISTS orb_trades_1m_exec_nofilters (
    ...
    con.execute("ALTER TABLE orb_trades_1m_exec_nofilters ADD COLUMN IF NOT EXISTS rr DOUBLE;")
    con.execute("ALTER TABLE orb_trades_1m_exec_nofilters ADD COLUMN IF NOT EXISTS mae_r DOUBLE;")
    con.execute("ALTER TABLE orb_trades_1m_exec_nofilters ADD COLUMN IF NOT EXISTS mfe_r DOUBLE;")
            ...
            for _, high, low, close in bars[entry_idx + 1:]:
                ...
                if direction == "UP":
                    ...
                    if hit_stop and hit_target:
                        outcome = "LOSS"
                        # FIXED R: Use ORB range as base, allow loss > -1R
